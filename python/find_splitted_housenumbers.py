...
for row in cur.fetchall():
	...
	cur2.execute("select * from newnodes where addr_street = '"+addr_street+"' and (addr_housenumber like '"+addr_housenumber+"a' or addr_housenumber like '"+addr_housenumber+"b' or addr_housenumber like '"+addr_housenumber+"c' or addr_housenumber like '"+addr_housenumber+"d' or addr_housenumber like '"+addr_housenumber+"e' or addr_housenumber like '"+addr_housenumber+"f' or addr_housenumber like '"+addr_housenumber+"g' or addr_housenumber like '"+addr_housenumber+"h' or addr_housenumber like '"+addr_housenumber+"i') order by addr_street, addr_housenumber")
	res = cur2.fetchall()
	if len(res) != 0:
		first = 1
